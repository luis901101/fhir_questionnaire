...
class QuestionnaireViewState extends State<QuestionnaireView>
  ...
  int get listViewCount =>
      itemBundles.length +
      ((questionnaire.title?.valueString?.isNotEmpty ?? false) ? 1 : 0);
            ...
            : Scrollbar(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final titleStr = questionnaire.title?.valueString;
                    if (index == 0 && (titleStr?.isNotEmpty ?? false)) {
                      return Padding(
